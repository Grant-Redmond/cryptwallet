...
import cryptwallet.utils.KeyDerivationTasks;

import java.time.Duration;

import static com.google.common.base.Preconditions.checkNotNull;
import static cryptwallet.utils.GuiUtils.*;
 ...
 */
public class CryptPasswordController {
    private static final Logger log = LoggerFactory.getLogger(CryptPasswordController.class);
    ...
    public static final String TAG = CryptPasswordController.class.getName() + ".target-time";
