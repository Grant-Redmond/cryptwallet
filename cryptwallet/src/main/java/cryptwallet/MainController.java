...
import cryptwallet.controls.NotificationBarPane;
import cryptwallet.utils.BitcoinUIModel;
import cryptwallet.utils.easing.EasingMode;
import cryptwallet.utils.easing.ElasticInterpolator;

import static cryptwallet.Main.bitcoin;
        ...
        transactionsList.setCellFactory(param -> new TextFieldListCell<>(new StringConverter<Transaction>() {
            ...
            public String toString(Transaction tx) {
                ...
                if (value.isPositive()) {
                    ...
                    return "Incoming Payment    " + MonetaryFormat.BTC.format(value) + "    from    " + address;
                } else if (value.isNegative()) {
                    Address address = tx.getOutput(0).getAddressFromP2PKHScript(Main.params);
                    return  "Outbound Payment    " + MonetaryFormat.BTC.format(value) + "    to    " + address;
                }
