...
import cryptwallet.utils.TextFieldValidator;
...
import static cryptwallet.utils.GuiUtils.checkGuiThread;
import static cryptwallet.utils.GuiUtils.informationalAlert;
import static cryptwallet.utils.WTUtils.didThrow;
import static cryptwallet.utils.WTUtils.unchecked;

public class CryptSettingsController {
    private static final Logger log = LoggerFactory.getLogger(CryptSettingsController.class);
    ...
    private void askForPasswordAndRetry() {
        Main.OverlayUI<CryptPasswordController> pwd = Main.instance.overlayUI("crypt_password.fxml");
        pwd.controller.aesKeyProperty().addListener((observable, old, cur) -> {
            // We only get here if the user found the right password. If they don't or they cancel, we end up back on
            // the main UI screen.
            checkGuiThread();
            Main.OverlayUI<CryptSettingsController> screen = Main.instance.overlayUI("crypt_settings.fxml");
    ...
    public void passwordButtonClicked(ActionEvent event) {
        if (aesKey == null) {
            Main.instance.overlayUI("crypt_set_password.fxml");
        } else {
